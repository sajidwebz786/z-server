...
const courses = [
  ...
  ['Zulanex Career Boost', 'career-boost', 'Six months access with trending tech courses, resume building support, mock interviews, internship projects, placement training, and dedicated support.', 'A career pass based on the Student Pass source materials: skill up, stand out, get hired.', 2, 3999, null, '6 Months', 'Job Ready', '/src/assets/zulanex-student-pass.jpeg', 'Zulanex Career Team', 'Career mentors, trainers, and placement support.', 4.8, 0, 0, 0, true, true, 2],
  ['Zulanex Elite Success Pro', 'elite-success-pro', 'One year access with 1:1 mentorship, live domain projects, portfolio building, HR interview mastery, global job-ready program, and priority support.', 'A success pass based on the Student Pass source materials: master, build, and succeed globally.', 3, 5999, null, '1 Year', 'Advanced', '/src/assets/zulanex-student-pass.jpeg', 'Zulanex Elite Mentors', 'Mentors supporting portfolio, HR interview, and job-ready preparation.', 4.9, 0, 0, 0, true, true, 3],
